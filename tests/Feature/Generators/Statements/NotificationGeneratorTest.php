...
final class NotificationGeneratorTest extends TestCase
{
    ...
    public function output_writes_notifications($draft): void
    {
        ...
        $this->assertGeneratorOutputEquals(['created' => ['app/Notification/ReviewPostNotification.php', 'app/Notification/PublishedPostNotification.php']], $this->subject->output($tree));
    }
    ...
    public function it_respects_configuration(): void
    {
        ...
        $this->assertGeneratorOutputEquals(['created' => ['src/path/Notification/ReviewNotification.php']], $this->subject->output($tree));
    }
